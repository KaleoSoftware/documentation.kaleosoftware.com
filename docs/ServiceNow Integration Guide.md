...
```javascript
  function getKaleoResults() {
    // CHANGE THESE VALUES FOR YOUR KALEO CONFIGURATION
    var KALEO_HOST = 'https://YOUR-TENANT-HERE.kaleosoftware.com';
    var WIDGET_TOKEN = 'YOUR WIDGET TOKEN';
    var SHARED_SECRET = 'YOUR authentication.shared_secret SETTING';
    var MAX_RESULTS = 5;
...
Now lets add our code to the Server Script for the ServiceNow Portal Typeahead Search widget:
...
(function() {
  ...
  // START KALEO CHANGES
  // Assuming we have pasted in the getKaleoResults function at the bottom of this file,
  // lets show Kaleo results only to users who are logged in to ServiceNow...
  if (gs.isLoggedIn())
...
// PASTE IN getKaleoResults function here
})();
```
...
For the client script portion of the Typeahead Widget, make these changes
